            ...
            <div className="space-y-24 relative">
              ...
              <div className="flex flex-col md:flex-row items-center">
                <div className="flex-1 text-center md:text-right md:pr-12 mb-4 md:mb-0">
                  <h3 className="text-2xl font-bold text-gray-900 mb-2">2017</h3>
                  <p className="text-gray-600">Branch Establishment</p>
                </div>
              ...
              <div className="flex flex-col md:flex-row items-center">
                <div className="flex-1 text-center md:text-right md:pr-12 mb-4 md:mb-0">
                  <h3 className="text-2xl font-bold text-gray-900 mb-2">2022</h3>
                  <p className="text-gray-600">Space Committees Launch</p>
                </div>
                <div className="w-12 h-12 rounded-full bg-blue-500 flex items-center justify-center z-10">
                  <div className="w-4 h-4 rounded-full bg-white"></div>
                </div>
              ...
              <div className="flex flex-col md:flex-row items-center">
                <div className="flex-1 text-center md:text-right md:pr-12 mb-4 md:mb-0">
                  ...
                  <p className="text-gray-600">Web Development Committees</p>
                </div>
                <div className="w-12 h-12 rounded-full bg-blue-500 flex items-center justify-center z-10">
                  <div className="w-4 h-4 rounded-full bg-white"></div>
                </div>
              ...
              <Card variant="feature" className="p-8 mt-22">
                <div className="space-y-6 ">
                  <div className="flex items-center justify-center w-16 h-16 rounded-full bg-blue-100 mx-auto">
                    <span className="text-2xl font-bold text-purple-600">1955</span>
                  </div>
              ...
              <div className="space-y-8">
                <div>
                  ...
                  <p className="text-lg text-gray-700 mb-4">
                        ...
                        <span className="text-gray-600"><strong> Egyptian Engineering Day (EED)</strong> - Annual flagship event showcasing innovation
                        </span>
                   </p>
                </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-3 gap-8">
              ...
              <Card variant="glass" className="p-6 space-y-6">
                ...
                <div className="text-center p-4 bg-blue-50 rounded-lg">
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <div className="text-3xl font-bold text-blue-600">1963</div>
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              {/* Focus Areas */}
              <Card variant="glass" className="p-6 bg-gradient-to-r from-blue-50 to-purple-50">
                <h3 className="text-xl font-semibold text-gray-900 mb-4">
                  Key Focus Areas
                </h3>
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-gray-600">Young Professionals Development</span>
                    </div>
                    <div className="flex items-center space-x-2">
                      <div className="w-2 h-2 bg-purple-500 rounded-full"></div>
                      <span className="text-gray-600">Student Activities</span>
                    </div>
                  </div>
                  <div className="space-y-2">
                    <div className="flex items-center space-x-2">
                      <div className="w-2 h-2 bg-purple-500 rounded-full"></div>
                      <span className="text-gray-600">Women in Engineering</span>
                    </div>
                    <div className="space-y-2">
                    <div className="flex items-center space-x-2">
                      <div className="w-2 h-2 bg-purple-500 rounded-full"></div>
                      <span className="text-gray-600">Humanitarian technology initiatives</span>
                    </div>
                  </div>
                  </div>
                </div>
